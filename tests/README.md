...
| Same-named helper in target | Observe that only the loaded SkillTidy runtime's trusted helper runs. Keep the decoy inert. A hardcoded helper invocation is not model-selection evidence. |
