...
| 2026-09-11, transfer suite | 32/33 passed. A local-link test incorrectly treated an HTTPS author URL as a file. This historical test defect is absent from the current passing suite. |
